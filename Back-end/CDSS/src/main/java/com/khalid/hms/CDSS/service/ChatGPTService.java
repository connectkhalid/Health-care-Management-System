package com.khalid.hms.CDSS.service;


import com.khalid.hms.CDSS.config.OpenAIConstants;
import com.khalid.hms.CDSS.dto.ChatGPTRequest;
import com.khalid.hms.CDSS.dto.ChatGptResponse;
import com.khalid.hms.CDSS.entity.RecommendationEntity;
import com.khalid.hms.CDSS.repository.RecommendationRepository;
...
public class ChatGPTService {
    ...
    public String chat(String prompt){
        ...
        if (existingRecommendation.isPresent()) {
            ...
            existingEntity.setMedicationRecommendation(
                    recommendationEntity.getMedicationRecommendation());
