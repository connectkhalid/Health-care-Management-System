...
import { GET_ALL_CANCELED_APPOINTMENT_DOCTOR_URL, GET_ALL_COMPLETED_APPOINTMENT_DOCTOR_URL, GET_CURRENT_APPOINTMENTS_BY_DOCTOR_ID_URL, GET_DOCTOR_PROFILE_BY_TOKEN_URL, GET_UPCOMING_APPOINTMENT_OF_DOCTOR_URL } from '../../utils/urls';
...
function DoctorAppointmentPage() {
    ...
    const getUpcomgingAppointments = () => {
        sendGetRequest(GET_UPCOMING_APPOINTMENT_OF_DOCTOR_URL, token)
            .then(response => {
                console.log(response)
    ...
    const getCancelledAppointments = () => {
        sendGetRequest(GET_ALL_CANCELED_APPOINTMENT_DOCTOR_URL, token)
            .then(response => {
                console.log(response)
    ...
    const getCompletedAppointments = () => {
        sendGetRequest(GET_ALL_COMPLETED_APPOINTMENT_DOCTOR_URL, token)
            .then(response => {
                console.log(response)
